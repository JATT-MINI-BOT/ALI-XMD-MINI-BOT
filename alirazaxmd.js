...
async function autoReconnectFromMongoDB() {
    try {
        ...
        alirazaLog(`Attempting auto-reconnect from MongoDB for [${currentServer}]...`, 'info');
        
        const numbers = await getAllNumbersFromMongoDB();
        if (!numbers.length) { alirazaLog(`No active numbers found for ${currentServer} in MongoDB.`, 'info'); return; }
        ...
        alirazaLog(`Auto-reconnect process completed for ${currentServer}`, 'success');

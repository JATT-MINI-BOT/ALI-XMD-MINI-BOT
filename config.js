...
module.exports = {
    ...
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://alirazaking147258:ali555raza555king.@cluster0.jf5nexq.mongodb.net/?appName=Cluster0',
    ...
    BOT_NAME: "✨𝑨𝑳𝑰 𝑿𝑴𝑫 𝑴𝑰𝑵𝑰 𝑩𝑶𝑻✨",
    BOT_FOOTER: '©ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴀʟɪ ʀᴀᴢᴀ',
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://whatsapp.com/channel/0029VbDYYAzATRSkeyugCc2x',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://i.ibb.co/4nV5ZHY1/file-00000000bd187209b3a2c923cb318f26.png',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbDYYAzATRSkeyugCc2x',

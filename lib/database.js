    ...
    try {
        ...
        await Session.findOneAndUpdate(
            ...
            { 
                ...
                assignedServer: currentServerName, // Bind session to current active server node
                updatedAt: new Date()
            },
    ...
    try {
        ...
        await ActiveNumber.findOneAndUpdate(
            ...
            { 
                ...
                isActive: true,
                assignedServer: currentServerName // Isolate active tracking to this server node
            },
            { upsert: true, new: true }
        );
        return true;

...
const GroupSetting = mongoose.models.AlirazaGroupSetting || mongoose.model('AlirazaGroupSetting', alirazaGroupSettingsSchema);
...
async function getUserConfigFromMongoDB(number) {
    try {
        ...
        const defaultConfig = {
            ...
            REJECT_MSG: '*🔕 ʏۆʀ ᴄᴀʟʟ ᴡᴀs ᴀᴜᴛۆᴍᴀᴛɪᴄᴀʟ ʀᴇᴊᴇᴄﺘᴇ頂..!*', READ_MESSAGE: 'false',

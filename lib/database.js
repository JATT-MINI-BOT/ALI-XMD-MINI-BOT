...
// ============ NEW ANTI-LINK SCHEMA ============
const alirazaAntiLinkSchema = new mongoose.Schema({
...
// ============ NEW ANTI-LINK MODEL REGISTER ============
const AntiLinkGroup = mongoose.models.AlirazaAntiLink || mongoose.model('AlirazaAntiLink', alirazaAntiLinkSchema);
...
module.exports = {
    connectdb, Session, UserConfig, OTP, ActiveNumber, Stats, GroupSetting, AntiLinkGroup,

...
const connectdb = async () => {
    try {
        ...
        await mongoose.connect(config.MONGODB_URI, {
            ...
            bufferCommands: true // ✅ FIXED: Changed to true to prevent crashes before connection is established
        });
...
const alirazaConfigSchema = new mongoose.Schema({
    ...
    config: {
        ...
        // ✅ FIXED: Corrected Mongoose standard schema structure for properties definition

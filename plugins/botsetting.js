...
*│ ╌─̇─̣⊰*💡*𝐂𝐎𝐌𝐌𝐀𝐍𝐃 𝐔𝐒𝐀𝐆𝐄*⊱┈─̇─̣╌*
*│─̇─̣┄┄┄┄┄┄┄┄┄┄┄┄┄─̇─̣*
*│* ❤️ Cmd: .autolikestatus
*│* 💡 Use: .autolikestatus on/off
*│* 📝 Ex: .autolikestatus on
*╰┄─̣┄─̇─̣┄─̇─̣┄─̇─̣┄─̇─̣─̇─̣─᛭*`;
            return conn.sendMessage(from, { text: usageLayout }, { quoted: fakevCard });
        }
